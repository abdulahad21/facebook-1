...
namespace Facebook
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<FacebookContext>(options => options.UseSqlServer(connectionString));
            ...
            services.AddIdentity<CustomUserFields, IdentityRole>().AddEntityFrameworkStores<FacebookContext>();
